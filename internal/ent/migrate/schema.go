...
var (
	...
	ProviderQuotaStatusColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP")},
		{Name: "deleted_at", Type: field.TypeInt, Default: 0},
		{Name: "provider_type", Type: field.TypeEnum, Enums: []string{"claudecode", "codex", "antigravity", "xai_subscription", "github_copilot", "nanogpt", "cline", "wafer", "synthetic", "neuralwatt", "apertis", "opencode_go", "kimi_code", "minimax", "zhipu", "zai", "charm_hyper", "zenmux", "commandcode", "ollama", "qianwen_token_plan"}},
	...
	RequestsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{RequestsColumns[30], RequestsColumns[1]},
			},
			{
				Name:    "requests_by_external_id_api_key_id_status_created_at",
				Unique:  false,
				Columns: []*schema.Column{RequestsColumns[14], RequestsColumns[26], RequestsColumns[15], RequestsColumns[1]},
			},
			{
