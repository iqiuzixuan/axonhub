...
func (ProviderQuotaStatus) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("provider_type").
			Values("claudecode", "codex", "antigravity", "xai_subscription", "github_copilot", "nanogpt", "cline", "wafer", "synthetic", "neuralwatt", "apertis", "opencode_go", "kimi_code", "minimax", "zhipu", "zai", "charm_hyper", "zenmux", "commandcode", "ollama", "qianwen_token_plan"),
		field.Enum("status").
