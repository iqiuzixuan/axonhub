...
func (*Request) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case request.FieldBilling, request.FieldRequestHeaders, request.FieldRequestBody, request.FieldResponseHeaders, request.FieldResponseBody, request.FieldResponseChunks:
			values[i] = new([]byte)
		...
		case request.FieldSource, request.FieldModelID, request.FieldOriginalModelID, request.FieldReasoningEffort, request.FieldFormat, request.FieldExternalID, request.FieldStatus, request.FieldClientIP, request.FieldUserAgent, request.FieldContentStorageKey:
