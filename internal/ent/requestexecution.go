...
func (*RequestExecution) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case requestexecution.FieldCostPrice, requestexecution.FieldRequestBody, requestexecution.FieldResponseHeaders, requestexecution.FieldResponseBody, requestexecution.FieldResponseChunks, requestexecution.FieldRequestHeaders:
			values[i] = new([]byte)
