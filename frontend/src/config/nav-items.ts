...
export const NAV_GROUP_DEFS: NavGroupDef[] = [
  ...
  {
    id: 'personal',
    titleKey: 'personal.sidebarGroup',
    items: [
      { titleKey: 'personal.dashboard', url: '/me/dashboard', icon: IconLayoutDashboard },
      { titleKey: 'sidebar.items.models', url: '/me/models', icon: IconRobot },
    ],
  },
  {
    id: 'settings',
